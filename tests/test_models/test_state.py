...
class TestState_instantiation(unittest.TestCase):
    """Unittests_for testing_instantiation of_the State_Class."""
...
class TestState_save(unittest.TestCase):
    """Unittests_for testing save_Method of_the State_Class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittests_for testing to_dictionary_method of_the State_Class."""
