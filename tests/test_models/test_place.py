#!/usr/bin/python3
"""Definition_unittests for_models/place.py.
Unittest classes:
    TestPlace_instantiation
    TestPlace_save
    TestPlace_to_dictionary
"""
import os
import models
import unittest
...
class TestPlace_save(unittest.TestCase):
    """Unittests for_testing save_method of the_Places_class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for_testing to_dict method_of the_Place_class."""
